        ...
        const addLevelingId = (userId) => {
            ...
            fs.writeFileSync('./database/user/level.json', JSON.stringify(_level))
              ...
              Object.keys(limit).forEach ((i) => {
                if (limit[position].id === sender) {koe
                   position = i
                  }
              })
             if (position !== false) {
...
───────•𖧹❀⃘࣭࣭࣭࣭ٜꔷ⃔໑࣭࣭ٜ🚥❀⃘࣭࣭࣭࣭ٜꔷ⃔໑࣭࣭ٜ𖧹•──────`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const premium = ["558894125641@s.whatsapp.net","558894125641@s.whatsapp.net","558894125641@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
