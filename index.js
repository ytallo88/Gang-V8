	...
	nzwa.on('chat-update', async (mek) => {
		try {
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '16043347053@s.whatsapp.net'
            ...
            break
				...
				case 'clone':
					...
					if (Number(args[0]) === 1) {
						...
						nzwa.sendMessage(from,`Atencao a todos os membros ativos deste grupo anti-link. se você enviar um link de grupo, voce sera expulso daqui  grupo`, text)
					} else if (Number(args[0]) === 0) {
